...
// ignore_for_file: camel_case_types, duplicate_ignore, file_names, prefer_const_constructors
...
//Referenciar a coleção do Firestore
  ...
  exibirItemColecao(item) {
    ...
    return ListTile(
      ...
      onTap: () {
      Navigator.pushNamed(context, '/esqueleto_publicacao', arguments: item.id);
      },
    );
  }
